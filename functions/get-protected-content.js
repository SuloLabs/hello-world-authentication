   ...
   const { type } = JSON.parse(event.body);
     ...
     if (!roles || !roles.some(role => allowedRoles.includes(role))) {
       return {
         statusCode: 402,
         body: JSON.stringify({
           src: 'https://images.unsplash.com/photo-1604238375994-ec5071343cc1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=2559&q=80',
